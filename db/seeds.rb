...
alan = Realtor.create(first_name: "Alan", last_name: "Golman", firm: "IMRG", username: "alangolm95", password: "pebbles723", email: "alan.golman@imrg.com", phone_number: "5166699024")

alex = User.create(first_name: "Alexandra", last_name: "Maluma", username: "maluma4ever", password: "dogsRGr8")

listing1 = Listing.create(realtor: alan, address_line_1: "233 Goldmans Ave", address_line_2: "6B", city: "New York", state: "New York", zipcode: "10003", price: 2200,
